#Clayton Treder
#This program is made to demonstrate Sierpinski's 
#Triangle. There are three fixed points and a starting 
#point. If you generate a random number between 1-3 and
#then move half to one of the corresponding points from
#the starting point, a pattern will emerge.
...
def mainPoints():  
    ...
    startPoint=canvas.create_rectangle(245,245,255,255, fill="Red")
